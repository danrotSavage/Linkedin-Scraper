...
# Add arguments
parser.add_argument('--location', type=str, help='location of jobs, i.e. Israel', required=False)
parser.add_argument('--pages', type=int, help='amount of times to scroll down in a search', required=False)
parser.add_argument('--jobsFile', type=str, help='file for the new jobs')
parser.add_argument('--unwantedJobsFile', type=str, help='file for the new unwanted jobs')
...
logging.info(f"location: {args.location}, pages: {args.pages}, jobsFile: {args.jobsFile}, unwantedJobsFile: {args.unwantedJobsFile}, keywords: {args.keywords}")
print(f"location: {args.location}, pages: {args.pages}, jobsFile: {args.jobsFile}, unwantedJobsFile: {args.unwantedJobsFile}, keywords: {args.keywords}", flush=True)
